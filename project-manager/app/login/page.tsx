...
export default function SignInPage() {
  ...
  const loginPM = usePmStore(state => state.loginPM);
  const verify2fa = usePmStore(state => state.verify2fa);
      ...
      <div className="flex-1 flex items-center justify-center px-6 md:px-16 py-12 relative overflow-hidden">
        ...
        <div className="max-w-3xl w-full relative z-10">
          ...
          {!is2faPending ? (
            ...
            <form className="space-y-7 animate-in fade-in duration-300" onSubmit={handleVerify2fa}>
              ...
              <div className="flex justify-between items-center text-xs font-bold text-slate-500">
                <button
                  type="button"
                  onClick={() => usePmStore.setState({ is2faPending: false, loginError: null })}
          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              <GoogleButton
                onClick={() => alert("Google OAuth2 authentication simulation triggered for project manager account validation.")}
                isLoading={false}
              />
            </div>
          </div>
